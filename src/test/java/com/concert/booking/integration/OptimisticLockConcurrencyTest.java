...
class OptimisticLockConcurrencyTest {
    ...
    void setUp() {
        // 콘서트 + 스케줄 + 좌석 1개 생성
        Concert concert = Concert.create("낙관적 락 동시성 테스트 콘서트", "설명", "장소", "아티스트");
    ...
    @Test
    @DisplayName("낙관적 락: 10명이 동시에 같은 좌석 1개 예매 → 1명만 성공")
    void optimistic_lock_concurrent_reservation_only_one_succeeds() throws InterruptedException {
        int threadCount = 10;
